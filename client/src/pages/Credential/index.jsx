...
// verify
import NewCredentialRequestForm from './displayForm'
import NewCredentialRequestEmailForm from './emailForm'
      ...
      <GridComponent item xs={12} md={6}>
        ...
        >
          ...
          <TabPanel value={value} index={0}>
            <NewCredentialRequestForm />
          </TabPanel>
          <TabPanel value={value} index={1}>
            <NewCredentialRequestEmailForm />
          </TabPanel>
        </CardComponent>
      </GridComponent>
      <GridComponent item xs={12} md={6}>
