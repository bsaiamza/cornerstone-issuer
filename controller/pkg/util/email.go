...
// SendCredentialEmail sends an email.
func SendCredentialEmail(name, recipientEmail, qrImgName string, qrCode []byte) error {
	...
	<body>
		<p>Hi ` + name + `</p>
		<p>Please scan the following <b>QR Code</b> with your wallet app to get your <b>Cornerstone Credential</b>: <br/><br/><img src="cid:` + qrImgName + `.png" alt="QR Code" /></p>
...
func SendNotificationEmail(name, recipientEmail string) error {
	...
	<body>
		<p>Hi ` + name + `</p>
		<p>Please note that your Cornerstone Credential has been issued and should be stored in your wallet.</p>
		<p>Regards<br/>Iamza Cornerstone Issuer</p>
	</body>
</html>`
